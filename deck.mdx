...
```jsx title="You can pass state as props to children" 19,29,30
class StatefulApp extends React.Component {
  constructor(props) {
    super(props);
...
```jsx file=./components/Counter.js
```

```jsx file=./components/Counter.js 4:6,17
```
...
```jsx title="Import BrowserRouter" 
...
<img width="750px" height="750px" src={fail_layout} />

---

import devtools from './images/devtools.png'

<img width="750px" height="750px" src={devtools} />

--- 

import fixed_layout from './images/fixed-layout.png'

<img width="750px" height="750px" src={fixed_layout} />
...
```jsx file=./frontend_src/Questions/Questions.js subtitle="Parameter: question" title="Retrieve Questions"
```

```jsx file=./frontend_src/Questions/Questions.js subtitle="Parameter: question" 43:48 title="Retrieve Questions"
```
